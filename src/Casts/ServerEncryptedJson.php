...
/**
 * Server-side encrypted JSON cast.
 *
 ...
 *
 * The server CAN decrypt these values. For zero-knowledge JSON encryption,
 * use `Bloxy\Crypto\EnvelopeEncryptedJson` from the bloxy-crypto package.
 */
class ServerEncryptedJson implements CastsAttributes
{
